...
import { useUserRegister } from "@/hook/auth.hook"; // Assuming you have a registration hook
        ...
        >
          ...
          <div className="lg:w-[100%]">
            <HookForm onSubmit={onSubmit} >
              ...
              {/* Image URL Field */}
              <motion.div className="py-3" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.8 }}>
                <FXInput label="Image URL" name="img" type="text" />
              </motion.div>
